...
- [X] 메인화면 출력
- [X] 메인 화면에서 기능 입력
  - [X] [ERROR] 올바르지 않은 명령 입력 시, 오류 메시지 출력 후 다시 실행
- [X] 입력에 따른 기능 수행 구현
- [X] 역 관리 선택 시
  - [X] [ERROR] 올바르지 않은 명령 입력 시, 오류 메시지 출력 후 다시 실행
  - [X] 역관리 화면 출력
  ...
  - [X] 역 등록 선택 시
    - [X] 등록할 역 이름 입력
    - [X] 이미 존재하는지 확인
    - [X] [ERROR] 이미 존재한다면 에러 발생 후, 다시 입력
    - [X] 입력된 역 등록
  - [X] 역 조회 시
    - [X] 존재하는 역 가져오기
    - [X] 존재하는 역 출력 후 종료하기
  - [X] 역 삭제 시
  - [X] [ERROR] 존재하지 않는 역일 시, 에러 발생 후 종료.
    - [X] 삭제할 역 이름 입력받기
    - [X] 입력받은 이름의 역 삭제하기
- [ ] 노선 관리 선택 시
  - [X] 노선 관리 화면 출력
    ...
    - [X] 입력에 따른 기능 수행 구현
      - [X] 노선 등록 선택 시
        - [X] 노선 이름 입력 
        - [X] 등록할 노선의 상행 종점역 이름 입력
        - [X] 등록할 노선의 하행 종점역 이름 입력
        - [X] 지하철 노선 등록하기
        - [X] [ERROR] 이미 존재하는 노선일 시, 오류 메시지 출력 후 다시 실행
        - [ ] [ERROR] 상행 종점역과 하행 종점역이 같다면, 오류 메시지 출력 후 다시 실행
        - [X] 지하철 노선 등록 완료 출력하기
      - [X] 노선 삭제 선택 시
        - [X] 삭제할 노선 입력받기
        - [X] 노선 삭제완료 화면 출력
        - [ ] [ERROR] 존재하지 않는 노선일 시, 오류 메시지 출력 후 다시 실행
  - [X] 구간 관리 선택 시
    - [X] 구간 관리 화면 출력
    - [X] [ERROR] 올바르지 않은 명령 입력 시, 오류 메시지 출력 후 다시 실행
    - [X] 입력에 따른 기능 수행 구현
      - [X] 구간 등록 선택 시
        - [X] 노선 입력받기
        - [ ] [ERROR] 노선 입력할 때 존재하지 않는 노선일 시, 오류 메시지 출력
        - [X] 역이름 입력받기
        - [ ] [ERROR] 노선 입력할 때 존재하지 않는 역일 시, 오류 메시지 출력
        - [X] 순서 입력 받기
        - [ ] [ERROR] 숫자가 아닐 시, 에러 메시지 출력
        - [X] 순서에 맞게 구간 삽입하기
        - [X] 구간 등록 완료 화면 출력
      - [X] 구간 삭제 선택 시
        - [X] 삭제할 노선 이름 입력
